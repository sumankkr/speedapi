...
class LambdaFunction {
  ...
  constructor(functionKey, functionDefinition, serverless, options) {
    ...
    if (_classPrivateFieldLooseBase(this, _artifact)[_artifact]) {
      ...
      _classPrivateFieldLooseBase(this, _lambdaDir)[_lambdaDir] = (0, _path.join)((0, _os.tmpdir)(), 'serverless-offline', 'services', service.service, functionKey, (0, _index3.createUniqueId)());
    }
